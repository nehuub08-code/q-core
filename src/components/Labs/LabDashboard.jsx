          ...
          {filteredLabs.map((lab) => {
            ...
            return (
              <button
                ...
                className={`p-5 rounded-3xl text-left bg-white border transition-all duration-200 relative overflow-hidden group flex flex-col justify-between shadow-xs hover:shadow-md cursor-pointer ${
                  isSelected
              ...
              >
                <div className="space-y-3">
                  ...
                  <div>
                    <h3 className="font-['Plus_Jakarta_Sans'] font-bold text-base text-slate-900 group-hover:text-blue-600 transition-colors">
                      {lab.title}
                    </h3>
                ...
                <div className="mt-4 pt-3 border-t border-slate-200 flex items-center justify-between text-xs font-semibold" style={{ color: lab.color }}>
