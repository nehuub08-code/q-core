          ...
          {currentList.map((app) => {
            ...
            return (
              <button
                ...
                className="bg-white dark:bg-slate-800 p-6 rounded-3xl border border-slate-200 dark:border-slate-700 hover:border-blue-500 text-left transition-all duration-200 group flex flex-col justify-between hover:-translate-y-1 relative overflow-hidden shadow-xs hover:shadow-md cursor-pointer"
              >
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <h3 className="font-['Plus_Jakarta_Sans'] text-base font-bold text-slate-900 dark:text-white group-hover:text-blue-600 transition-colors">
                      {app.title}
                    </h3>
                  </div>
                ...
                <div className="mt-6 pt-3 border-t border-slate-100 dark:border-slate-700 flex items-center justify-between text-xs font-semibold" style={{ color: app.color }}>
          ...
          {selectedApp && (
            ...
            >
              <motion.div
                ...
                className="bg-white dark:bg-slate-800 p-6 sm:p-8 rounded-3xl border border-slate-200 dark:border-slate-700 max-w-2xl w-full relative space-y-6 shadow-2xl"
              >
                {/* Close Button */}
                <button
                  onClick={handleClose}
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-700 text-xs font-mono text-slate-700 dark:text-slate-200 space-y-1">
                    <div className="font-bold text-slate-900 dark:text-white text-[11px]">Hardware Specifications & Benchmarks:</div>
                    <div className="text-slate-600 dark:text-slate-300">{selectedApp.hardwareSpecs}</div>
                  </div>
                </div>
                ...
                <div className="flex justify-end pt-2">
                  <button
                    onClick={handleClose}
                    className="px-5 py-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600 text-slate-800 dark:text-slate-200 text-xs font-semibold transition-all shadow-xs cursor-pointer"
                  >
                    Close Overview
                  </button>
                </div>
